...
class SVD2Dott:
    ...
    def generate(self) -> None:
        """
        Reads the XML file set in the constructor and writes the DOTT register file to the file specified in the
        constructor.
        """
        with open(self._out_file, 'w', encoding='ascii', newline=self._newline) as f:
            ...
            f.write(tw.dedent(f"""
                # This file is automatically generated from an XML register description using {basename(__file__)}.
